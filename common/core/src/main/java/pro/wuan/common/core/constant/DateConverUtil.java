...
public final class DateConverUtil {
	 ...
	 * 
	 * @param sdate
	 *            传入的字符串。例如：2013-11-05
	 * @param toTypes
	 *            传入的字符串时间类型格式，例如：yyyy-MM-dd HH:mm:ss
	 * @return Date日期对象
	 * 
	 *         示例：String time="2013-11-01 11:22";
	 *         DateConverUtil.dd1(time);或者DateConverUtil.dd1(time,"yyyy-MM-dd
	 *         HH:mm");
	 */
	 ...
	 * 
	 * @param type
	 *            传入的转换成的日期格式 , DateConverUtil.TimeType中有一部分日期时间格式
	 * @return 字符串类型
	 * 
	 *         示例：DateConverUtil.dd2(new
	 *         Date(),DateConverUtil.TimeType.type2.getValue()) 或者
	 *         DateConverUtil.dd2(new Date(),"yyyy-MM-dd H:m:s") ;
	 */
