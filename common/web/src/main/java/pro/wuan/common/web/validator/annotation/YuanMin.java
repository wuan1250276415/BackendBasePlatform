...
import pro.wuan.common.web.validator.constraintvalidators.impl.YuanMinConstraintValidator;
...
/**
 * 元转元最小值后台校验, value：999999.99， 转成元后保留2位精度，四舍五入
 *
...
@Retention(RUNTIME)
@Repeatable(YuanMin.List.class)
@Documented
@Constraint(validatedBy = YuanMinConstraintValidator.class)
public @interface YuanMin {
