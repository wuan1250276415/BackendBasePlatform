...
import pro.wuan.common.web.validator.constraintvalidators.impl.WanYuanToYuanMinConstraintValidator;
...
/**
 * 万元转元最小值后台校验, value：999999.99999， 转成元后保留2位精度，四舍五入
 *
...
@Retention(RUNTIME)
@Repeatable(WanYuanToYuanMin.List.class)
@Documented
@Constraint(validatedBy = WanYuanToYuanMinConstraintValidator.class)
public @interface WanYuanToYuanMin {

    String message() default "{javax.validation.constraints.DecimalMix.message}";
