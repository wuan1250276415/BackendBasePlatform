...
/**
 * 万元转元最大值，转成元后，2位精度，四舍五入，配合统一后台校验
 *
 * @program: tellhowcloud
 * @author: HawkWang
 * @create: 2021-12-26 07:16
 **/
public class WanYuanToYuanMaxConstraintValidator implements ConstraintValidator<WanYuanToYuanMax, BigDecimal> {
    ...
    @Override
    public void initialize(WanYuanToYuanMax constraintAnnotation) {
        try {
            ...
            this.maxValue = bigDecimal.movePointRight(4).setScale(this.scale > 4 ? this.scale -4 : 2, roundingMode);
    ...
    public boolean isValid(BigDecimal value, ConstraintValidatorContext context) {
        ...
        int comparisonResult = value.compareTo(maxValue);
