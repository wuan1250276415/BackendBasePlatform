 ...
 **/
public class YuanMaxConstraintValidator implements ConstraintValidator<YuanMax, BigDecimal> {
    ...
    @Override
    public void initialize(YuanMax constraintAnnotation) {
        try {
            ...
            this.maxValue = bigDecimal.setScale(this.scale, roundingMode);
