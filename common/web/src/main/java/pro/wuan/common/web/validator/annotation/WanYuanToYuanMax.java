...
import pro.wuan.common.web.validator.constraintvalidators.impl.WanYuanToYuanMaxConstraintValidator;
...
@Retention(RUNTIME)
@Repeatable(WanYuanToYuanMax.List.class)
@Documented
@Constraint(validatedBy = WanYuanToYuanMaxConstraintValidator.class)
public @interface WanYuanToYuanMax {
     ...
     */
    String value() default "99999999.999999";
